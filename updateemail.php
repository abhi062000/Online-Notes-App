...
if (!$result) {
    ...
    $message .= "http://thesite.offyoucode.co.uk/onlinenotes/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
    if (mail($newemail, 'Email Update for you Online Notes App', $message, 'From:' . 'abhishekghanekar2000@gmail.com')) {
